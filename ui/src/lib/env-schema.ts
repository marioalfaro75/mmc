...
export const ENV_SCHEMA: EnvVarDef[] = [
  ...
  { key: 'WIREGUARD_MTU', label: 'WireGuard MTU', type: 'integer', group: 'vpn', description: 'Tunnel MTU size — default 1420. Lower to 1280 only if you see VPN issues on WSL2 or double-NAT links', default: '1420', affectsServices: VPN_SERVICES },
